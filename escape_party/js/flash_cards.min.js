...
$(document).ready(function(){
    ...
    function onAfter(){
      ...
      var cardurl = $(this).parent().find('.current').find('img').get(0).src;
      var cardname = "";
      var found = false;
      $.getJSON('https://create.espora.net/games/escape_party/data.json', function(cards) {
        cardname = cardurl.substring(cardurl.lastIndexOf('/')+1).split("_")[0];
        found = cards.includes(cardname);
       
        if(found)
        {
          $(this).parent().find('.current').toggleClass('flip');
        }
      });
    }
    // Keyboard Nav
    $(document).keydown(function (e) {
      ...
      switch (keyCode) {
        ...
        case key.enter:
        case key.space:
          var cardurl = $('.current img').get(0).src;
          var cardname = "";
          var found = false;
          $.getJSON('https://create.espora.net/games/escape_party/data.json', function(cards) {
            cardname = cardurl.substring(cardurl.lastIndexOf('/')+1).split("_")[0];
