...
function checkstatus(){
  $.getJSON('https://create.espora.net/games/escape_party/data.json', {_: new Date().getTime()}, function(cards) {  
    $("img").each(function() {  
      var cardurl = this.src;
      var cardname = cardurl.substring(cardurl.lastIndexOf('/')+1).split("_")[0];
      var found = cards.includes(cardname);

      if(found)
      {
        this.src = cardurl.replace("_back.jpg", "_front.jpg");
      }
    });
  });
}
